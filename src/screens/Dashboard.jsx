...
const Dashboard = () => {
  ...
  const [isServiceUserSubMenuOpen, setIsServiceUserSubMenuOpen] =
    useState(false);
          ...
          <ul>
            <li>
              <Link
                to="adminDashboard"
                className={
                  location.pathname.includes("adminDashboard") ? "active" : ""
                }
            ...
            <li>
              <Link
                to="location"
                className={
                  location.pathname.includes("location") ? "active" : ""
                }
                onClick={closeSidebar}
              >
                ...
                <ul className="sub-menu">
                  <li>
                    <Link
                      to="userDetails"
                      className={
                        location.pathname.includes("userDetails")
                          ? "active"
                          : ""
                      }
                      onClick={closeSidebar}
                  ...
                  <li>
                    <Link
                      to="hostDetails"
                      className={
                        location.pathname.includes("hostDetails")
                          ? "active"
                          : ""
                      }
                      onClick={closeSidebar}
                  ...
                  <li className="user-menu">
                    <button
                      ...
                      onClick={toggleServiceUserSubMenu}
                    >
                      <MdOutlinePerson className="menu-icon" />
