      ...
      {validStations.map((station, index) => (
        <div key={index} className="station-card">
          ...
          <div className="station-header">
            ...
            <button className="get-details-button" onClick={() => toggleDetails(index)}>
          ...
          {expandedStations[index] && (
            <div className="station-details">
              ...
              <div className="detail-box"><strong>Power Rating</strong><span>{station.powerRating}</span></div>
              <div className="detail-box"><strong>Usage Type</strong><span>{station.usageType}</span></div>
              <div className="detail-box"><strong>Availability</strong><span>{station.availability}</span></div>
              <div className="detail-box"><strong>Cost per Unit</strong><span>₹{station.cost} / KWh</span></div>
              <div className="detail-box"><strong>Vendor</strong><span>{station.vendorName}</span></div>
              <div className="detail-box"><strong>Last Used</strong><span>{station.lastUsed}</span></div>
